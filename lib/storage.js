...
storage.flushToStorage = function (options, callback) {
  ...
  //do not flush on mobile, not supported
  // Windows or Ti can't fsync (FlushFileBuffers) directories. We can live with this as it cannot cause 100% dataloss
  // except in the very rare event of the first time database is loaded and a crash happens
  if (this['Ti'] || flags === 'r') { return callback(null); }
